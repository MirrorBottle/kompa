...
/**
    ...
    public function index($user_id)
    {
        ...
        return view("admin.user-commission-rates.index", compact('rates', 'user'));
    }
    ...
    public function create($user_id)
    {
        ...
        return view("admin.user-commission-rates.create", compact('user', 'rates'));
    }
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('admin.user-commission-rates.index', $request->user_id)->with('success','Data rencana komisi berhasil diubah!');
    }
    ...
    public function destroy($id)
    {
        ...
        $commission->delete();
        return redirect()->route('admin.user-commission-rates.index')->with('success','Data persentase komisi berhasil dihapus!');
