        ...
        @csrf
            ...
            <div class="grid gap-4 sm:grid-cols-2 sm:gap-6 py-4">
                ...
                <div class="grid gap-4 sm:grid-cols-2 sm:gap-6">
                    ...
                    <div>
                        ...
                        <input type="text" name="commission_amount" id="commission_amount" class="form-input"
            ...
            <div class="py-4">
                <label for= "message" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Catatan
                    Manager</label>
                <textarea id="manager_note" name='manager_note' rows="4" class="form-input"
                    placeholder="Tulis catatan mu di sini">{{ $salary->manager_note }}</textarea>
            </div>
            <div class="py-4">
                <label for= "message" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Catatan
                    Finance</label>
                <textarea id="finance_note" name='finance_note' rows="4" class="form-input" readonly
                    placeholder="Tulis catatan mu di sini">{{ $salary->finance_nore }}</textarea>
            </div>
            <div class="py-4">
