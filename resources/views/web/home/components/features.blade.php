        ...
        <div class="mx-auto w-full max-w-7xl">
            <div class="flex-col flex gap-y-20 max-[479px]:gap-[60px] items-center lg:items-center py-20 lg:py-24">
                <div class="flex-col flex items-center gap-y-[16px] sm:gap-y-4">
                    ...
                    <p class="text-center text-[#e6e6e6] text-base sm:text-base">Kami punya serangkaian fitur keren di Kompa yang bisa bikin pengelolaan data perusahaan jadi lebih mudah. <br>Ayo, kita intip lebih dalam!
                    </p>
                </div>
